                    ...
                    <div class="col-md-6">
                        <div class="form-group radio_c_group no_label">
                            ...
                            <label class="container_radio">Delivery
                                <input type="checkbox" name="delivery" value="1" @if($data && $data->delivery == 1) checked @endif>
                                <span class="checkmark"></span>
                            </label>
                            <label class="container_radio">Collection
                                <input type="checkbox" name="collection" value="1" @if($data && $data->collection == 1) checked @endif>
                                <span class="checkmark"></span>
                            </label>
                            <label class="container_radio">Table Service
                                <input type="checkbox" name="table_service" value="1" @if($data && $data->table_service == 1) checked @endif>
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
