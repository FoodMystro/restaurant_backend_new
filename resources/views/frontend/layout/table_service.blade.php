...
<body data-spy="scroll" data-bs-target="#secondary_nav" data-offset="75" style="margin-top:70px;">


	<main>

		<div class="hero_in detail_page background-image" data-background="url({{asset('')}}assets/img/hero_general-2.jpg)">
					...
					<div class="main_info">
						<div class="row">
							<div class="col-xl-4 col-lg-5 col-md-6">
								<h1>Papa Nadox Kitchen</h1>
								Afro Caribbean - 1 Kitson Road, SE5 7LF - <a
	...
	<div class="content">
		...
		<div class="footer">
			<div class="row small-gutters">
				...
				<div class="col-md-12">
					{{-- <button  data-id="{{ $item->id }}" data-token="{{ csrf_token() }}" type="reset" class="add_cart full-width">Add to cart</button> --}}
